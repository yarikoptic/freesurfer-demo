...
static char vcid[] = "$Id: mri_surf2surf.c,v 1.87.2.1 2010/07/01 16:30:13 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surf2surf.c,v 1.87.2.1 2010/07/01 16:30:13 greve Exp $", "$Name:  $");
