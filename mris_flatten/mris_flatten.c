...
static char vcid[] = "$Id: mris_flatten.c,v 1.27.2.2 2007/02/05 20:39:18 nicks Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_flatten.c,v 1.27.2.2 2007/02/05 20:39:18 nicks Exp $", "$Name:  $");
