...
char *VERSION = "$Revision: 1.341.2.1 $";
...
void ParseCmdLineArgs ( int argc, char *argv[] ) {
  ...
  nNumProcessedVersionArgs =
    ...
    (argc, argv,
     "$Id: tkmedit.c,v 1.341.2.1 2010/08/04 20:47:28 greve Exp $",
     "$Name:  $");
...
int main ( int argc, char** argv ) {
  ...
  *MATRIX_RELT(gm_screen2ras, 4, 4) = 1 ;
  ...
  DebugPrint
    (
      (
        "$Id: tkmedit.c,v 1.341.2.1 2010/08/04 20:47:28 greve Exp $ $Name:  $\n"
        )
      );
