...
// $Id: mri_fieldsign.c,v 1.12.2.1 2010/07/14 14:51:52 greve Exp $
...
static char vcid[] = "$Id: mri_fieldsign.c,v 1.12.2.1 2010/07/14 14:51:52 greve Exp $";
char *Progname = NULL;
