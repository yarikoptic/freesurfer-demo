...
static char vcid[] = "$Id: mri_label2vol.c,v 1.32.2.1 2011/01/04 19:21:44 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  make_cmd_version_string (argc, argv,
                           "$Id: mri_label2vol.c,v 1.32.2.1 2011/01/04 19:21:44 greve Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv,
                                 "$Id: mri_label2vol.c,v 1.32.2.1 2011/01/04 19:21:44 greve Exp $", "$Name:  $");
